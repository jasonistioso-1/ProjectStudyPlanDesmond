  ...
  const content = (
    <div className="bg-white border-t-4 border-t-red-600 border border-slate-200 rounded-2xl p-6 md:p-8 shadow-2xl max-w-2xl w-full mx-auto font-sans relative">
      ...
      <div className="text-center mb-6">
        ...
        <h2 className="text-xl font-extrabold text-slate-900 tracking-tight mt-2 font-heading">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 mb-5">
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          ...
          <button
            ...
            className="p-2 bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-200 rounded-xl transition-colors shrink-0"
