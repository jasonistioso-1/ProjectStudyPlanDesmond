                  ...
                  >
                    <div className="min-w-0 pr-2">
                      <div className="flex items-center gap-2">
                        <span className="font-mono font-semibold text-slate-900 text-xs">{unit.code}</span>
                        <span className="text-slate-700 text-xs font-medium truncate max-w-[150px]">
                          {unit.title}
                        </span>
                      </div>
                    ...
                    <button
                      ...
                      className="px-2.5 py-1 bg-slate-100 hover:bg-slate-200 text-slate-800 border border-slate-200 text-xs font-medium rounded-md transition-colors flex items-center gap-1 shrink-0"
                    >
